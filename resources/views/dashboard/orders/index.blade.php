...
{{--                                        <th>@lang('site.status')</th>--}}
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td><span id="total">{{ number_format($order->total_price, 2) }}</span></td>
                                            <td><span id="amount">{{ number_format($order->paid, 2) }}</span></td>
                                            <td><span id="remaining">{{ number_format($order->remaining, 2) }}</span></td>
                                            {{--<td>--}}
                                                {{--<button--}}
