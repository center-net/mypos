                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <h4>@lang('site.paid') : <input type="number" name="paid"  class="form-control input-sm amount-paid" min="1" value="{{ number_format($order->paid, 2) }}"></h4>
                                <h4>@lang('site.remaining') : <span class="remaining-amount">{{ number_format($order->remaining, 2) }}</span></h4>
