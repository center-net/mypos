                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.store', $client->id) }}" method="post">
                                ...
                                <h4>@lang('site.paid') : <input type="number" name="paid"  class="form-control input-sm amount-paid" min="1" value="0"></h4>
                                <h4>@lang('site.remaining') : <span class="remaining-amount">0</span></h4>
